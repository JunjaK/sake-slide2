...
<div v-click="[6,7]" class="step">
  <div class="text">7. 히이레(火入れ): 양조한 술을 살균처리하는 과정. 여과전, 병입시 2차례에 걸쳐 열처리를 진행함 <br> 이 과정을 생략한 것이 나마자케(生酒)라고 불림</div>
</div>
...
<div v-click="[7,8]" class="step">
  <div class="text">8. 여과(ろ過): 술에 있는 여러 불순물을 제거하는 과정, 이 과정을 생략한 것이 무로카(無濾過)라고 불림</div>
</div>
...
<div v-click="[8,9]" class="step">
  <div class="text">9. 저장・숙성(貯蔵・熟成): 술을 저장하고 숙성하는 과정. 긴조슈는 반년 이상 숙성을 거치는 경우가 많음</div>
</div>
